...
//  */
//  const y = "hello world"; // 🚨 ERROR : Variable jamais lu
...
// let zz: number;
// zz = 41;
// zz = "abc";// 🚨 ERROR : Type 'number' is not assignable to type 'string'
...
// let aa: number[] = [];
// aa.push(33);
// aa.push("abc");// 🚨 ERROR : Type 'number' is not assignable to type 'string'
